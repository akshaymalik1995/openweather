...
export default function WeatherCard(props: { weatherData: any }) {
  ...
  return (
    <div className="">
      <div className="">
        <h2 className="text-3xl md:text-6xl text-center my-16 dark:text-white">
        ...
        <div className="mx-auto bg-opacity-60 flex flex-col max-w-2xl  dark:bg-gray-800 shadow-lg w-full rounded-lg dark:text-gray-100">
          ...
          <div className="grid items-center grid-cols-1 md:grid-cols-2">
            <div className="flex p-4 items-center justify-center gap-4  col-span-1">
              <div className="dark:text-white flex flex-col  gap-2  px-2 rounded p-1 ">
                <div className="flex  gap-2 items-center ">
                  ...
                  <div className="text-[6rem] md:text-[7rem] leading-none relative">
                    ...
                    <div className="absolute -right-3 md:-right-8  font-bold -top-0 md:-top-2 text-2xl md:text-5xl">
                      o
                    </div>
                    <div className="absolute bottom-1 -right-3 md:-right-7 text-gray-400 font-bold md:bottom-2 text-3xl  md:text-5xl">
                      c
                    </div>
                  </div>
                </div>
            ...
            <div className="flex dark:bg-gray-600 bg-gray-200 col-span-1 justify-center p-4 h-full  flex-col">
